...
if __name__ == '__main__':
    ...
    parser.add_argument("--dup",required=True,type=float)

    args = parser.parse_args()

    pyutils.Logger(osp.join('./experiments', args.name,'rw','aff_%02d%02d_%02d.log'%(args.low,args.high,args.dup)))
    ...
    for ep in range(args.max_epoches):
        ...
        for iter, pack in enumerate(train_data_loader):
            ...
            if (optimizer.global_step) % 200 == 0 and optimizer.global_step>2590:
            # if (optimizer.global_step) % 200 == 0 and optimizer.global_step>1290:
