...
# import resnet38d
from networks import resnet38d, resnet101
...
class model_WSSS():
    ...
    def __init__(self, args):
        ...
        self.net_dl = resnet101.DeepLabV2(
    ...
    def train_setup(self):
        ...
        args = self.args
        param_dl = self.get_params(self.net_dl)

        self.opt_dl =  optimizer = torch.optim.SGD(
        params=[
            {
                "params": self.get_params(self.net_dl.module, key="1x"),
                "lr": CONFIG.SOLVER.LR,
                "weight_decay": CONFIG.SOLVER.WEIGHT_DECAY,
            },
            {
                "params": self.get_params(self.net_dl.module, key="10x"),
                "lr": 10 * CONFIG.SOLVER.LR,
                "weight_decay": CONFIG.SOLVER.WEIGHT_DECAY,
            },
            {
                "params": self.get_params(self.net_dl.module, key="20x"),
