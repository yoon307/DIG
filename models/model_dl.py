...
# CUDA_VISIBLE_DEVICES=0,1,2,3 python train_dl.py --name CTS_dl2 --gt_path /mnt/shyoon4tb/RIB/result_voc/CTS/sem_seg/
...
class model_WSSS():
    ...
    def infer_multi(self, epo, val_path, dict_path, crf_path, vis=False, dict=False, crf=False):
        ...
        thread_pool = pyutils.BatchThreader(_work, list(enumerate(self.img)), batch_size=scale_len, prefetch_size=0, processes=16)
