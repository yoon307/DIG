...
if __name__ == '__main__':
    ...
    # parser.add_argument("--val_list", default="./coco14/train14_tiny.txt", type=str)
    ...
    # Experiments
    parser.add_argument("--model", default='trm_cnn3', type=str)
    ...
    parser.add_argument('--scale', default=(0.3,1.2), type=parse_tuple) #0.6-1.2
    parser.add_argument('--scale2', default=(0.3,1.2), type=parse_tuple) #0.3-0.7
